...
static int __init at91_adc_init(void){
	...
	printk(KERN_INFO "Registered device atmel_adc.\n");
	return 0;
...
static void __exit at91_adc_exit(void){
	...
	printk(KERN_INFO "Unregistered device atmel_adc.\n");
}
...
MODULE_DESCRIPTION("ADC Driver for the AT91");
MODULE_LICENSE("GPL");
